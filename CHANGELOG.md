...
- python.bash: unset `PYTHONHOME` at shell startup. A foreign `PYTHONHOME`
  (mise/pyenv stdlib tree without its own lib-dynload) breaks embedded
...
[0.5.0]: https://github.com/log0u7/myflec/compare/v0.4.1...v0.5.0
[0.4.1]: https://github.com/log0u7/myflec/compare/v0.4.0...v0.4.1
